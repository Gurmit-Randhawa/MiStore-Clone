...
import abc from '../Images/my pic.jpg';

export const HireMe = () => {
  const HoverEffect = document.getElementById('HireMe');
  HoverEffect.style.backgroundColor = "#ff5823";
  HoverEffect.style.fontSize = "14px";
}

export const HireMeLeave = () => {
  const HoverEffect = document.getElementById('HireMe');
...
export const GetResume = () => {
  const HoverEffect = document.getElementById('GetResume');
  HoverEffect.style.backgroundColor = "transparent";
  HoverEffect.style.fontSize = "14px";

}

export const GetResumeLeave = () => {
  const HoverEffect = document.getElementById('GetResume');
  HoverEffect.style.backgroundColor = "#ff5823";
  HoverEffect.style.fontSize = "13px";
      ...
      <div className="homepage">
        ...
        <ImageSection>
          ...
          <InfoSection>
            ...
            <InfoBox size={"25px"}>Mern Stack Developer</InfoBox>
            <InfoBox size={"9px"}>
              Knack of building applications with front and back end operations.
            </InfoBox>
            <ButtonBox>
              <button onMouseMove={HireMe} onMouseLeave={HireMeLeave}  id="HireMe" style={BtnStyle}>Hire Me</button>
              <button onMouseOver={GetResume} onMouseLeave={GetResumeLeave} id="GetResume">Get Resume</button>
            </ButtonBox>
          </InfoSection>
